...
\item [ ] With this code I successfully send a string in a function that can’t handle a string and prints the return value in the console of my browser. Written in my console is NaN, which means not a number. But if ‘“string”’ was changed to 2 for example, this would have worked fine.
...
{\bfseries Algorithm descriptions}
\begin{description}
