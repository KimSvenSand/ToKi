...
JavaScript is a prototype based with first class functions. This makes it a multi-paradigm language with support for Object-oriented, imperative and functional paradigms. Since we are comparing FP and OOP we will ignore the imperative paradigm.  How does the support of FP and OOP look in JavaScript, how many of the listed concepts above is supported?
...
We will implement the algorithms using Atom, a text editor, and compile and run our tests an1d our code with Node.js. To manage our dependencies we are using npm. For automation we are using Grunt.
